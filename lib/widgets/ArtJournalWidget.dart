...
class Journal extends StatefulWidget {
  ...
  const Journal({this.jorunalId, this.ownerId, this.likes, this.username, this.title, this.text, this.pic});

  factory Journal.fromDocument(DocumentSnapshot documentSnapshot){
    return Journal(
      jorunalId: documentSnapshot["jorunalId"],
...
class _JournalState extends State<Journal> {
  ...
  _JournalState({this.jorunalId, this.ownerId,
    this.likes, this.username, this.title, this.text,
    this.pic, this.likeCount});
